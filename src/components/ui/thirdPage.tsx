...
export const ThirdPage = () => {
  return (
    <section className="from-background via-secondary to-background w-full bg-linear-to-b via-70% pb-10">
      <div id="aboutMe" className="max-w-5xl py-14 pb-10 lg:m-auto lg:py-16">
      ...
      <article className="w-full">
        <div className="m-auto flex max-w-5xl flex-col gap-5 p-2 py-10 min-[550px]:flex-row min-[550px]:items-center sm:px-10 lg:justify-between">
          <div className="flex flex-col gap-5 sm:flex-row sm:items-center lg:flex-row">
            ...
            <div className="flex flex-col gap-5">
              ...
              <p className="">
                Há mais de <span className="font-bold">10 anos</span>, acompanho{" "}
                <span className="font-bold">
              ...
              <a className="m-auto w-full md:m-0" href="https://wa.link/6mo3a2">
                <ButtonCTA
