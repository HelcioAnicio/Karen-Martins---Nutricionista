...
export const SecondPage = () => {
  return (
    <section className="m-auto flex w-full justify-center bg-[url(public/designBackgroundSecond.png)] bg-cover bg-center bg-no-repeat sm:items-center lg:bg-top-right">
        ...
        <article className="flex w-full max-w-5xl flex-col gap-5 p-1 px-4 sm:gap-16 sm:px-10">
          ...
          <div className="flex w-full max-w-max flex-col gap-5 py-10">
            ...
            <p className="border-primary bg-background rounded-r-md border-l-4 p-2 py-2 pl-2">
              ...
              respeitando as necessidades de cada fase. <br /> Este
              acompanhamento é ideal para gestantes que querem garantir:{" "}
            </p>
          </div>
            ...
            <ul className="flex flex-col gap-10 px-3">
              ...
              <li className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <p>
                    Melhora de sintomas como enjoos, azia, inchaços e sensação
                    de fraqueza.
                  </p>
                </div>
              </li>
              ...
              <li className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <p>
                    Redução de riscos relacionados à hipertensão gestacional
                  </p>
                </div>
              </li>
              <li className="flex items-center gap-5">
